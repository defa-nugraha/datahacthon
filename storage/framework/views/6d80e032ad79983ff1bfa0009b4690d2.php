<?php $__env->startSection('title', 'Manajemen Perangkat - Agro Smart'); ?>
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <?php $__currentLoopData = $iotDevices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            
            <div class="p-4 border-b flex justify-between items-center bg-gray-50">
                <h2 class="text-lg font-bold text-gray-800"><?php echo e($device['zona']); ?></h2>
            ...
            <div class="p-5 space-y-3">
                <div>
                    ...
                    <p class="text-sm font-mono bg-gray-100 p-1 rounded mt-1 text-gray-700"><?php echo e($device['mac_address']); ?></p>
                </div>
                
                <div class="flex justify-between border-t pt-3">
                    <div>
                        <p class="text-xs text-gray-500 font-semibold uppercase">Status Lahan</p>
                        <p class="text-sm font-bold text-gray-800"><?php echo e($device['tanaman']); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-gray-500 font-semibold uppercase">Update Terakhir</p>
                        <p class="text-sm text-gray-600"><?php echo e($device['last_ping']); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/zones.blade.php ENDPATH**/ ?>